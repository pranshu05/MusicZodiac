...
export const metadata: Metadata = {
    title: "404 - Page Not Found | Music Zodiac",
    description: "The page you're looking for has drifted into a musical black hole. Navigate back to discover your cosmic musical identity.",
    robots: {
        index: false,
        follow: false,
    },
...
export default function NotFound() {
    const jsonLd = {
        ...
        description: "The requested page could not be found on Music Zodiac.",
        url: "https://musiczodiac.com/404",
    }
