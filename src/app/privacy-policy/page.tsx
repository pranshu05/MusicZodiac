...
export const metadata: Metadata = {
    title: "Privacy Policy | Music Zodiac",
    description: "Learn how Music Zodiac protects your data and privacy. Understand what information we collect, how we use it, and your rights regarding your personal data.",
    openGraph: {
        title: "Privacy Policy | Music Zodiac",
        description: "Learn how Music Zodiac protects your data and privacy.",
        type: "website",
    },
    robots: {
        index: true,
...
export default function PrivacyPolicyPage() {
    const jsonLd = {
        ...
        "@type": "WebPage",
        name: "Privacy Policy",
        description: "Music Zodiac's privacy policy explaining data collection, usage, and user rights.",
        url: "https://musiczodiac.com/privacy-policy",
