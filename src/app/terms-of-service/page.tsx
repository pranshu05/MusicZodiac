...
export const metadata: Metadata = {
    title: "Terms of Service | Music Zodiac",
    description: "Read Music Zodiac's terms of service to understand your rights and responsibilities when using our cosmic music discovery platform.",
    openGraph: {
        title: "Terms of Service | Music Zodiac",
        description: "Read Music Zodiac's terms of service and user agreement.",
        type: "website",
    },
    robots: {
        index: true,
...
export default function TermsOfServicePage() {
    const jsonLd = {
        ...
        description: "Music Zodiac's terms of service and user agreement.",
        url: "https://musiczodiac.com/terms-of-service",
