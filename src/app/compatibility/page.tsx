...
export default async function CompatibilityPage() {
    ...
    const compatibilityScores = otherUsers
        ...
        .sort((a: {user: typeof otherUsers[number], score: number, matchingSigns: string[]}, b: {user: typeof otherUsers[number], score: number, matchingSigns: string[]}) => b.score - a.score)
